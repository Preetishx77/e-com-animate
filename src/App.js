...
<h1 style={{fontWeight:'normal'}}>$67 </h1>
    ...
    <Row className='mt-4'>
      <Row>
      <Col>
      <img src={female} alt="female" onClick={() => setImg(female)} style={{width:'150px'}} />
      </Col>
      <Col>
      <img src={photo2} alt="female" onClick={() => setImg(photo2)} style={{width:'150px'}} />
      </Col>
      <Col>
      <img src={photo3} alt="female" onClick={() => setImg(photo3)} style={{width:'150px'}} />
      </Col>
      <Col>
      </Col>
      </Row>
    ...
    <img src={`${img}`} alt="female" style={{float:'right',marginTop:'5vh',height:'90%'}} />
